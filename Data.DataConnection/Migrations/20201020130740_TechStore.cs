        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedAt = table.Column<DateTime>(nullable: true),
                    DeletedAt = table.Column<DateTime>(nullable: true),
                    SallerNumber = table.Column<string>(nullable: false),
                    UserId1 = table.Column<int>(nullable: true),
                    UserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SellerCustomers_Customers_CustomerId1",
                        column: x => x.CustomerId1,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SellerCustomers_Sellers_SellerId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SellerCustomers_CustomerId1",
                table: "SellerCustomers",
                column: "CustomerId1");

            migrationBuilder.CreateIndex(
                name: "IX_SellerCustomers_SellerId1",
                table: "SellerCustomers",
                column: "SellerId1");
